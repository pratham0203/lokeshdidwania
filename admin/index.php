...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
              ...
              <li class="nav-item">
                ...
                <a href="pages/examples/projects.html" class="nav-link">
                  ...
                  <p>Projects</p>
                                ...
                                <li class="nav-item">
                                    <a href="pages/examples/books-add.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Books Add</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="pages/examples/books-edit.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Books Edit</p>
                                    </a>
                                </li>
                  ...
                  <p>Contact us</p>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="pages/examples/blogs-edit.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Blogs Edit</p>
                                    </a>
                                </li>
              ...
              <li class="nav-item">
                <a href="starter.html" class="nav-link">
                  ...
                  <p>Starter Page</p>
                        ...
                        <!-- <li class="nav-item">
            <a href="https://Admin Panel.io/docs/3.1/" class="nav-link">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-infos clearfix">
                                                <span class="direct-chat-name float-left">Lokesh Didwania</span>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2021 <a>Lokesh Didwania</a>.</strong>
            All rights reserved.
